...
impl Default for TMessageIdentifier {
    fn default() -> Self {
        Self {
            name: "".to_string(),
...
impl Default for TFieldIdentifier {
    fn default() -> Self {
        Self {
            name: None,
...
/// Mini-lust note: repr as u8 to avoid calling field_type_to_u8
#[derive(
    Clone, Copy, Debug, Eq, PartialEq, num_enum::TryFromPrimitive, num_enum::IntoPrimitive,
)]
#[repr(u8)]
pub enum TType {
...
#[inline]
pub fn field_type_from_u8(ttype: u8) -> crate::Result<TType> {
